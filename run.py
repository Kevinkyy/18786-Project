...
def evaluate_zengarden(n_runs: int=20, save_videos: bool = True):
    base_seed = 1234
    stats = {}
    # options for video
...
if __name__ == '__main__':
    ...
    parser.add_argument('--evaluate_zengarden', '-el', action='store_true', help="Evaluate controllers on zengarden track")
